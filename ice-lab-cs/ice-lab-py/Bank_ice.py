...
if 'Account' not in _M_Bank.__dict__:
    ...
    class Account(Ice.Object):
        ...
        def transfer(self, accountNumber, amount, current=None):
            pass
    ...
    class AccountPrx(Ice.ObjectPrx):
        ...
        def transfer(self, accountNumber, amount, _ctx=None):
            return _M_Bank.Account._op_transfer.invoke(self, ((accountNumber, amount), _ctx))

        def begin_transfer(self, accountNumber, amount, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_Bank.Account._op_transfer.begin(self, ((accountNumber, amount), _response, _ex, _sent, _ctx))

        def end_transfer(self, _r):
            return _M_Bank.Account._op_transfer.end(self, _r)
    ...
    Account._op_transfer = IcePy.Operation('transfer', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_int, False, 0)), (), None, (_M_Bank._t_IncorrectAccountNumber, _M_Bank._t_IncorrectAmount))
...
if 'PremiumAccount' not in _M_Bank.__dict__:
    ...
    PremiumAccount._op_calculateLoan = IcePy.Operation('calculateLoan', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0), ((), _M_Bank._t_currency, False, 0), ((), IcePy._t_int, False, 0)), (((), IcePy._t_int, False, 0), ((), IcePy._t_float, False, 0)), None, (_M_Bank._t_IncorrectData,))
...
if 'PersonalData' not in _M_Bank.__dict__:
    ...
    class PersonalData(object):
        def __init__(self, firstName='', lastName='', NationalIDNumber=''):
